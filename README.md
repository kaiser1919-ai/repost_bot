...
- `last_seen_posts.json` / `synced_posts.json` — файлы для отслеживания уже обработанных и синхронизированных постов. Создается автоматически при запуске бота.
- `logs.log` — логи работы бота. Создается автоматически.
